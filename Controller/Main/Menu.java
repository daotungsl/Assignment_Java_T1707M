...
public class Menu {
    ...
    public void studentInfo() {
        ...
        studentController.getInfoStudentId(id);
    }
    public void studentInfo2() {
        ...
        choiceInfo = scanner.nextInt();
        switch (choiceInfo) {
            case 1:
                studentController.getInfoId();
                break;
            case 2:
                studentController.getInfoRollNumber();
                break;
            case 3:
                studentController.getInfoName();
                break;
            case 4:
                editStudent();
                break;
